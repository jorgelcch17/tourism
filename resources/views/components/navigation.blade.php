@props(['bgopacity'=>'100'])
<div class="absolute inset-x-0 top-0 bg-white bg-opacity-{{$bgopacity}} z-10">
        ...
        <div class="flex justify-between items-center py-6 md:justify-start md:space-x-10">
            <div class="flex justify-start lg:w-0 lg:flex-1">
                <a href="{{route('home')}}">
                    ...
                    @else
                        <span class="text-3xl font-bold text-gray-700">CAMIRI</span>
                    @endif
                </a>
            </div>
            ...
            <div class="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
                @if(request()->is('/'))
                    <a href="#" class="whitespace-nowrap text-base font-medium text-gray-100 hover:text-gray-300"> Sign in</a>
                @else
                    <a href="#" class="whitespace-nowrap text-base font-medium text-gray-500 hover:text-gray-900"> Sign in</a>
                @endif
                
                <a href="#"
                    class="ml-8 whitespace-nowrap inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-cyan-400 hover:bg-cyan-600">
                    Sign up </a>
            </div>
        </div>
    </div>
    <div class="absolute top-0 inset-x-0 p-2 transition transform origin-top-right hidden">
        <div class="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-white divide-y-2 divide-gray-50">
            ...
            <div class="py-6 px-5 space-y-6">
                ...
                <div>
                    <a href="#"
                        class="w-full flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-sky-400 hover:bg-indigo-700">
                        Sign up </a>
